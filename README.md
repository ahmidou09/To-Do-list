...
This project is a To-Do List application created using webpack
...
# 📖 To-Do List application created using webpack <a name="about-project"></a>

This project involves building a simple HTML To Do list that will be styled according to the provided specifications. The web page will be created using webpack and served by a webpack dev server.
...
```sh
  ...
  git clone https://github.com/ahmidou09/To-Do-list.git
```
